...
def take_picture():
    if request.method == "POST":
        ...
        return render_template("take_picture.html",picture_status=picture_status,fname=pic_fname) 
    else:
        picture_status = None
...
def display_pictures():
    ...
    print(image_names)
    full_filename = os.path.join(app.config["UPLOAD_FOLDER"],"image_20210625-120144.jpg")
    return render_template("display_picture.html",image_names=image_names,user_image=full_filename)
